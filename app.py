...
class MyTableWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.pushButton_2_3.clicked.connect(lambda: self.action("H1XT_1_MV"))
        self.pushButton_2_4 = QPushButton(" 2 ")
        self.pushButton_2_4.clicked.connect(lambda: self.action("H1XT_2_MV"))
        self.pushButton_2_5 = QPushButton(" 3 ")
        self.pushButton_2_5.clicked.connect(lambda: self.action("H1XT_3_MV"))
        self.pushButton_2_6 = QPushButton(" 4 ")
        self.pushButton_2_6.clicked.connect(lambda: self.action("H1XT_4_MV"))
        self.pushButton_2_7 = QPushButton(" 5 ")
        self.pushButton_2_7.clicked.connect(lambda: self.action("H1XT_5_MV"))
        self.pushButton_2_8 = QPushButton(" 6 ")
        self.pushButton_2_8.clicked.connect(lambda: self.action("H1XT_6_MV"))
        self.pushButton_2_9 = QPushButton(" 7 ")
        self.pushButton_2_9.clicked.connect(lambda: self.action("H1XT_7_MV"))
        self.pushButton_2_10 = QPushButton(" 8 ")
        self.pushButton_2_10.clicked.connect(lambda: self.action("H1XT_8_MV"))
        self.pushButton_2_11 = QPushButton(" 9 ")
        self.pushButton_2_11.clicked.connect(lambda: self.action("H1XT_9_MV"))
        self.pushButton_2_12 = QPushButton(" 10 ")
        self.pushButton_2_12.clicked.connect(lambda: self.action("H1XT_10_MV"))
        self.pushButton_2_13 = QPushButton(" 11 ")
        self.pushButton_2_13.clicked.connect(lambda: self.action("H1XT_11_MV"))
        self.pushButton_2_14 = QPushButton(" 12 ")
        self.pushButton_2_14.clicked.connect(lambda: self.action("H1XT_12_MV"))
        self.pushButton_2_15 = QPushButton(" 13 ")
        self.pushButton_2_15.clicked.connect(lambda: self.action("H1XT_13_MV"))
        self.pushButton_2_16 = QPushButton(" 14 ")
        self.pushButton_2_16.clicked.connect(lambda: self.action("H1XT_14_MV"))
        self.pushButton_2_17 = QPushButton(" 15 ")
        self.pushButton_2_17.clicked.connect(lambda: self.action("H1XT_15_MV"))
        self.pushButton_2_18 = QPushButton(" 16 ")
        self.pushButton_2_18.clicked.connect(lambda: self.action("H1XT_16_MV"))
        self.pushButton_2_19 = QPushButton(" 17 ")
        self.pushButton_2_19.clicked.connect(lambda: self.action("H1XT_17_MV"))
        self.pushButton_2_20 = QPushButton(" 18 ")
        self.pushButton_2_20.clicked.connect(lambda: self.action("H1XT_18_MV"))
        self.pushButton_2_21 = QPushButton(" 19 ")
        self.pushButton_2_21.clicked.connect(lambda: self.action("H1XT_19_MV"))
        self.pushButton_2_22 = QPushButton(" 20 ")
        self.pushButton_2_22.clicked.connect(lambda: self.action("H1XT_20_MV"))
        self.pushButton_2_23 = QPushButton(" 21 ")
        self.pushButton_2_23.clicked.connect(lambda: self.action("H1XT_21_MV"))
        self.pushButton_2_24 = QPushButton(" 22 ")
        self.pushButton_2_24.clicked.connect(lambda: self.action("H1XT_22_MV"))
        self.pushButton_2_25 = QPushButton(" 23 ")
        self.pushButton_2_25.clicked.connect(lambda: self.action("H1XT_23_MV"))
        #
        ...
        self.pushButton_3_3.clicked.connect(lambda: self.action("H1YL_1_MV"))
        self.pushButton_3_4 = QPushButton(" 2 ")
        self.pushButton_3_4.clicked.connect(lambda: self.action("H1YL_2_MV"))
        self.pushButton_3_5 = QPushButton(" 3 ")
        self.pushButton_3_5.clicked.connect(lambda: self.action("H1YL_3_MV"))
        self.pushButton_3_6 = QPushButton(" 4 ")
        self.pushButton_3_6.clicked.connect(lambda: self.action("H1YL_4_MV"))
        self.pushButton_3_7 = QPushButton(" 5 ")
        self.pushButton_3_7.clicked.connect(lambda: self.action("H1YL_5_MV"))
        self.pushButton_3_8 = QPushButton(" 6 ")
        self.pushButton_3_8.clicked.connect(lambda: self.action("H1YL_6_MV"))
        self.pushButton_3_9 = QPushButton(" 7 ")
        self.pushButton_3_9.clicked.connect(lambda: self.action("H1YL_7_MV"))
        self.pushButton_3_10 = QPushButton(" 8 ")
        self.pushButton_3_10.clicked.connect(lambda: self.action("H1YL_8_MV"))
        self.pushButton_3_11 = QPushButton(" 9 ")
        self.pushButton_3_11.clicked.connect(lambda: self.action("H1YL_9_MV"))
        self.pushButton_3_12 = QPushButton(" 10 ")
        self.pushButton_3_12.clicked.connect(lambda: self.action("H1YL_10_MV"))
        self.pushButton_3_13 = QPushButton(" 11 ")
        self.pushButton_3_13.clicked.connect(lambda: self.action("H1YL_11_MV"))
        self.pushButton_3_14 = QPushButton(" 12 ")
        self.pushButton_3_14.clicked.connect(lambda: self.action("H1YL_12_MV"))
        self.pushButton_3_15 = QPushButton(" 13 ")
        self.pushButton_3_15.clicked.connect(lambda: self.action("H1YL_13_MV"))
        self.pushButton_3_16 = QPushButton(" 14 ")
        self.pushButton_3_16.clicked.connect(lambda: self.action("H1YL_14_MV"))
        self.pushButton_3_17 = QPushButton(" 15 ")
        self.pushButton_3_17.clicked.connect(lambda: self.action("H1YL_15_MV"))
        self.pushButton_3_18 = QPushButton(" 16 ")
        self.pushButton_3_18.clicked.connect(lambda: self.action("H1YL_16_MV"))
        self.pushButton_3_19 = QPushButton(" 17 ")
        self.pushButton_3_19.clicked.connect(lambda: self.action("H1YL_17_MV"))
        self.pushButton_3_20 = QPushButton(" 18 ")
        self.pushButton_3_20.clicked.connect(lambda: self.action("H1YL_18_MV"))
        self.pushButton_3_21 = QPushButton(" 19 ")
        self.pushButton_3_21.clicked.connect(lambda: self.action("H1YL_19_MV"))
        self.pushButton_3_22 = QPushButton(" 20 ")
        self.pushButton_3_22.clicked.connect(lambda: self.action("H1YL_20_MV"))
        #
        ...
        self.pushButton_4_3.clicked.connect(lambda: self.action("H1YR_1_MV"))
        self.pushButton_4_4 = QPushButton(" 2 ")
        self.pushButton_4_4.clicked.connect(lambda: self.action("H1YR_2_MV"))
        self.pushButton_4_5 = QPushButton(" 3 ")
        self.pushButton_4_5.clicked.connect(lambda: self.action("H1YR_3_MV"))
        self.pushButton_4_6 = QPushButton(" 4 ")
        self.pushButton_4_6.clicked.connect(lambda: self.action("H1YR_4_MV"))
        self.pushButton_4_7 = QPushButton(" 5 ")
        self.pushButton_4_7.clicked.connect(lambda: self.action("H1YR_5_MV"))
        self.pushButton_4_8 = QPushButton(" 6 ")
        self.pushButton_4_8.clicked.connect(lambda: self.action("H1YR_6_MV"))
        self.pushButton_4_9 = QPushButton(" 7 ")
        self.pushButton_4_9.clicked.connect(lambda: self.action("H1YR_7_MV"))
        self.pushButton_4_10 = QPushButton(" 8 ")
        self.pushButton_4_10.clicked.connect(lambda: self.action("H1YR_8_MV"))
        self.pushButton_4_11 = QPushButton(" 9 ")
        self.pushButton_4_11.clicked.connect(lambda: self.action("H1YR_9_MV"))
        self.pushButton_4_12 = QPushButton(" 10 ")
        self.pushButton_4_12.clicked.connect(lambda: self.action("H1YR_10_MV"))
        self.pushButton_4_13 = QPushButton(" 11 ")
        self.pushButton_4_13.clicked.connect(lambda: self.action("H1YR_11_MV"))
        self.pushButton_4_14 = QPushButton(" 12 ")
        self.pushButton_4_14.clicked.connect(lambda: self.action("H1YR_12_MV"))
        self.pushButton_4_15 = QPushButton(" 13 ")
        self.pushButton_4_15.clicked.connect(lambda: self.action("H1YR_13_MV"))
        self.pushButton_4_16 = QPushButton(" 14 ")
        self.pushButton_4_16.clicked.connect(lambda: self.action("H1YR_14_MV"))
        self.pushButton_4_17 = QPushButton(" 15 ")
        self.pushButton_4_17.clicked.connect(lambda: self.action("H1YR_15_MV"))
        self.pushButton_4_18 = QPushButton(" 16 ")
        self.pushButton_4_18.clicked.connect(lambda: self.action("H1YR_16_MV"))
        self.pushButton_4_19 = QPushButton(" 17 ")
        self.pushButton_4_19.clicked.connect(lambda: self.action("H1YR_17_MV"))
        self.pushButton_4_20 = QPushButton(" 18 ")
        self.pushButton_4_20.clicked.connect(lambda: self.action("H1YR_18_MV"))
        self.pushButton_4_21 = QPushButton(" 19 ")
        self.pushButton_4_21.clicked.connect(lambda: self.action("H1YR_19_MV"))
        self.pushButton_4_22 = QPushButton(" 20 ")
        self.pushButton_4_22.clicked.connect(lambda: self.action("H1YR_20_MV"))
        #
        ...
        self.pushButton_5_1 = QPushButton(" Hits ")
        self.pushButton_5_2 = QPushButton(" Efficiency ")
        self.pushButton_5_3 = QPushButton(" 1 ")
        self.pushButton_5_3.clicked.connect(lambda: self.action("H2XT_1_MV"))
        self.pushButton_5_4 = QPushButton(" 2 ")
        self.pushButton_5_4.clicked.connect(lambda: self.action("H2XT_2_MV"))
        self.pushButton_5_5 = QPushButton(" 3 ")
        self.pushButton_5_5.clicked.connect(lambda: self.action("H2XT_3_MV"))
        self.pushButton_5_6 = QPushButton(" 4 ")
        self.pushButton_5_6.clicked.connect(lambda: self.action("H2XT_4_MV"))
        self.pushButton_5_7 = QPushButton(" 5 ")
        self.pushButton_5_7.clicked.connect(lambda: self.action("H2XT_5_MV"))
        self.pushButton_5_8 = QPushButton(" 6 ")
        self.pushButton_5_8.clicked.connect(lambda: self.action("H2XT_6_MV"))
        self.pushButton_5_9 = QPushButton(" 7 ")
        self.pushButton_5_9.clicked.connect(lambda: self.action("H2XT_7_MV"))
        self.pushButton_5_10 = QPushButton(" 8 ")
        self.pushButton_5_10.clicked.connect(lambda: self.action("H2XT_8_MV"))
        self.pushButton_5_11 = QPushButton(" 9 ")
        self.pushButton_5_11.clicked.connect(lambda: self.action("H2XT_9_MV"))
        self.pushButton_5_12 = QPushButton(" 10 ")
        self.pushButton_5_12.clicked.connect(lambda: self.action("H2XT_10_MV"))
        self.pushButton_5_13 = QPushButton(" 11 ")
        self.pushButton_5_13.clicked.connect(lambda: self.action("H2XT_11_MV"))
        self.pushButton_5_14 = QPushButton(" 12 ")
        self.pushButton_5_14.clicked.connect(lambda: self.action("H2XT_12_MV"))
        self.pushButton_5_15 = QPushButton(" 13 ")
        self.pushButton_5_15.clicked.connect(lambda: self.action("H2XT_13_MV"))
        self.pushButton_5_16 = QPushButton(" 14 ")
        self.pushButton_5_16.clicked.connect(lambda: self.action("H2XT_14_MV"))
        self.pushButton_5_17 = QPushButton(" 15 ")
        self.pushButton_5_17.clicked.connect(lambda: self.action("H2XT_15_MV"))
        self.pushButton_5_18 = QPushButton(" 16 ")
        self.pushButton_5_18.clicked.connect(lambda: self.action("H2XT_16_MV"))
        #
        self.tab5.layout.addWidget(self.pushButton_5_1, 0, 0)
        self.tab5.layout.addWidget(self.pushButton_5_2, 0, 1)
        self.tab5.layout.addWidget(self.pushButton_5_3, 1, 0)
        self.tab5.layout.addWidget(self.pushButton_5_4, 1, 1)
        self.tab5.layout.addWidget(self.pushButton_5_5, 1, 2)
        self.tab5.layout.addWidget(self.pushButton_5_6, 1, 3)
        self.tab5.layout.addWidget(self.pushButton_5_7, 1, 4)
        self.tab5.layout.addWidget(self.pushButton_5_8, 2, 0)
        self.tab5.layout.addWidget(self.pushButton_5_9, 2, 1)
        self.tab5.layout.addWidget(self.pushButton_5_10, 2, 2)
        self.tab5.layout.addWidget(self.pushButton_5_11, 2, 3)
        self.tab5.layout.addWidget(self.pushButton_5_12, 2, 4)
        self.tab5.layout.addWidget(self.pushButton_5_13, 3, 0)
        self.tab5.layout.addWidget(self.pushButton_5_14, 3, 1)
        self.tab5.layout.addWidget(self.pushButton_5_15, 3, 2)
        self.tab5.layout.addWidget(self.pushButton_5_16, 3, 3)
        self.tab5.layout.addWidget(self.pushButton_5_17, 3, 4)
        self.tab5.layout.addWidget(self.pushButton_5_18, 4, 0)
        #
        self.tab5.setLayout(self.tab5.layout)

        # Create H2XB PMTs
        self.tab6.layout = QGridLayout(self)
        self.pushButton_6_1 = QPushButton(" Hits ")
        self.pushButton_6_2 = QPushButton(" Efficiency ")
        self.pushButton_6_3 = QPushButton(" 1 ")
        self.pushButton_6_3.clicked.connect(lambda: self.action("H2XB_1_MV"))
        self.pushButton_6_4 = QPushButton(" 2 ")
        self.pushButton_6_4.clicked.connect(lambda: self.action("H2XB_2_MV"))
        self.pushButton_6_5 = QPushButton(" 3 ")
        self.pushButton_6_5.clicked.connect(lambda: self.action("H2XB_3_MV"))
        self.pushButton_6_6 = QPushButton(" 4 ")
        self.pushButton_6_6.clicked.connect(lambda: self.action("H2XB_4_MV"))
        self.pushButton_6_7 = QPushButton(" 5 ")
        self.pushButton_6_7.clicked.connect(lambda: self.action("H2XB_5_MV"))
        self.pushButton_6_8 = QPushButton(" 6 ")
        self.pushButton_6_8.clicked.connect(lambda: self.action("H2XB_6_MV"))
        self.pushButton_6_9 = QPushButton(" 7 ")
        self.pushButton_6_9.clicked.connect(lambda: self.action("H2XB_7_MV"))
        self.pushButton_6_10 = QPushButton(" 8 ")
        self.pushButton_6_10.clicked.connect(lambda: self.action("H2XB_8_MV"))
        self.pushButton_6_11 = QPushButton(" 9 ")
        self.pushButton_6_11.clicked.connect(lambda: self.action("H2XB_9_MV"))
        self.pushButton_6_12 = QPushButton(" 10 ")
        self.pushButton_6_12.clicked.connect(lambda: self.action("H2XB_10_MV"))
        self.pushButton_6_13 = QPushButton(" 11 ")
        self.pushButton_6_13.clicked.connect(lambda: self.action("H2XB_11_MV"))
        self.pushButton_6_14 = QPushButton(" 12 ")
        self.pushButton_6_14.clicked.connect(lambda: self.action("H2XB_12_MV"))
        self.pushButton_6_15 = QPushButton(" 13 ")
        self.pushButton_6_15.clicked.connect(lambda: self.action("H2XB_13_MV"))
        self.pushButton_6_16 = QPushButton(" 14 ")
        self.pushButton_6_16.clicked.connect(lambda: self.action("H2XB_14_MV"))
        self.pushButton_6_17 = QPushButton(" 15 ")
        self.pushButton_6_17.clicked.connect(lambda: self.action("H2XB_15_MV"))
        self.pushButton_6_18 = QPushButton(" 16 ")
        self.pushButton_6_18.clicked.connect(lambda: self.action("H2XB_16_MV"))
        #
        self.tab6.layout.addWidget(self.pushButton_6_1, 0, 0)
        self.tab6.layout.addWidget(self.pushButton_6_2, 0, 1)
        self.tab6.layout.addWidget(self.pushButton_6_3, 1, 0)
        self.tab6.layout.addWidget(self.pushButton_6_4, 1, 1)
        self.tab6.layout.addWidget(self.pushButton_6_5, 1, 2)
        self.tab6.layout.addWidget(self.pushButton_6_6, 1, 3)
        self.tab6.layout.addWidget(self.pushButton_6_7, 1, 4)
        self.tab6.layout.addWidget(self.pushButton_6_8, 2, 0)
        self.tab6.layout.addWidget(self.pushButton_6_9, 2, 1)
        self.tab6.layout.addWidget(self.pushButton_6_10, 2, 2)
        self.tab6.layout.addWidget(self.pushButton_6_11, 2, 3)
        self.tab6.layout.addWidget(self.pushButton_6_12, 2, 4)
        self.tab6.layout.addWidget(self.pushButton_6_13, 3, 0)
        self.tab6.layout.addWidget(self.pushButton_6_14, 3, 1)
        self.tab6.layout.addWidget(self.pushButton_6_15, 3, 2)
        self.tab6.layout.addWidget(self.pushButton_6_16, 3, 3)
        self.tab6.layout.addWidget(self.pushButton_6_17, 3, 4)
        self.tab6.layout.addWidget(self.pushButton_6_18, 4, 0)
        #
